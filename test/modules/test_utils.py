...
def test_loadJson():
    ...
    assert u.loadJson("./test/modules/testJsons/comments.jsonc")["test"] == "testing"
    assert (
        u.loadJson("./test/modules/testJsons/withoutcomments.json")["test"] == "testing"
    )
...
def test_loadConfig():
    ...
    x = u.loadConfig(
        "./test/modules/testJsons/c.jsonc", "./test/modules/testJsons/r.jsonc"
    )
